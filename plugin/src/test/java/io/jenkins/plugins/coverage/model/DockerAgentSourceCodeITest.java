...
class DockerAgentSourceCodeITest extends SourceCodeITest {
    ...
    private static final AgentContainer AGENT_CONTAINER = new AgentContainer()
            .withCopyFileToContainer(MountableFile.forClasspathResource("io/jenkins/plugins/coverage/model/" + SOURCE_FILE), CONTAINER_PATH);
    ...
    @Override
    protected void copySourceFileToAgent(final String sourceDirectory, final hudson.model.Node localAgent, final WorkflowJob job) {
